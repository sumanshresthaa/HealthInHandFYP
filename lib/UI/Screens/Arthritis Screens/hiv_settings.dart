...
class HivSettings extends StatefulWidget {
  @override
  State<HivSettings> createState() => _HivSettingsState();
}

class _HivSettingsState extends State<HivSettings> {
